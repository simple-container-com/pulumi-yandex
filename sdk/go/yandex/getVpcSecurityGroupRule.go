...
//			_, err := yandex.GetVpcSecurityGroupRule(ctx, &yandex.LookupVpcSecurityGroupRuleArgs{
//				RuleId:               "my-rule-id",
...
// - `fromPort` (*Read-Only*) (Number).
// - `id` (*Read-Only*) (String).
// - `labels` (*Read-Only*) (Map Of String).
// - `port` (*Read-Only*) (Number).
// - `predefinedTarget` (*Read-Only*) (String).
// - `protocol` (*Read-Only*) (String).
// - `ruleId` (**Required**)(String).
// - `securityGroupBinding` (**Required**)(String).
// - `securityGroupId` (*Read-Only*) (String).
// - `toPort` (*Read-Only*) (Number).
// - `v4CidrBlocks` (*Read-Only*) (List Of String).
// - `v6CidrBlocks` (*Read-Only*) (List Of String).
...
func LookupVpcSecurityGroupRuleOutput(ctx *pulumi.Context, args LookupVpcSecurityGroupRuleOutputArgs, opts ...pulumi.InvokeOption) LookupVpcSecurityGroupRuleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupVpcSecurityGroupRuleResultOutput, error) {
			args := v.(LookupVpcSecurityGroupRuleArgs)
			options := pulumi.InvokeOutputOptions{InvokeOptions: internal.PkgInvokeDefaultOpts(opts)}
			return ctx.InvokeOutput("yandex:index/getVpcSecurityGroupRule:getVpcSecurityGroupRule", args, LookupVpcSecurityGroupRuleResultOutput{}, options).(LookupVpcSecurityGroupRuleResultOutput), nil
