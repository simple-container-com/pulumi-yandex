...
//
// ```sh
// $ pulumi import yandex:index/organizationmanagerOrganizationIamMember:OrganizationmanagerOrganizationIamMember editor "abjjf**********p3gp8,editor,foo@example.com"
// ```
type OrganizationmanagerOrganizationIamMember struct {
	...
	OrganizationmanagerOrganizationIamMemberId pulumi.StringOutput `pulumi:"organizationmanagerOrganizationIamMemberId"`
...
type organizationmanagerOrganizationIamMemberState struct {
	...
	// The ID of this resource.
	OrganizationmanagerOrganizationIamMemberId *string `pulumi:"organizationmanagerOrganizationIamMemberId"`
	// The role that should be assigned to the member.
...
type OrganizationmanagerOrganizationIamMemberState struct {
	...
	// The ID of this resource.
	OrganizationmanagerOrganizationIamMemberId pulumi.StringPtrInput
	// The role that should be assigned to the member.
...
// The ID of this resource.
func (o OrganizationmanagerOrganizationIamMemberOutput) OrganizationmanagerOrganizationIamMemberId() pulumi.StringOutput {
	return o.ApplyT(func(v *OrganizationmanagerOrganizationIamMember) pulumi.StringOutput {
		return v.OrganizationmanagerOrganizationIamMemberId
	}).(pulumi.StringOutput)
}
